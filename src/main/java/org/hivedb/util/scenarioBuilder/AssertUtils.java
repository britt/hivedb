...
public class AssertUtils  {
	...
	public static void assertThrows(Toss toss, Class<? extends Exception> exceptionType)
	{
		...
		Assert.fail("Expected exception of type " + exceptionType.getName() + " but no exception occured occured");
	}
	/**
	...
	public static void assertDoesNotThrow(Toss toss)
	{
		try {
			...
			Assert.fail("Got unexpected exception: " + e.getMessage() + e.getStackTrace());
		}
	}
}
