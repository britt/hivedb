...
//		
//		Collection<PartitionDimension> missingPartitionDimensions = getMissingItems(PartitionDimension.class, hive, updater);
//		
//		Collection<Entry<PartitionDimension, PartitionDimension>> partitionDimensionPairs =	getLikeNamedInstances(PartitionDimension.class, hive, updater);
...
//									Resource.class, 
//									(Finder)hive.findByName(PartitionDimension.class, partitionDimension.getName()), 
